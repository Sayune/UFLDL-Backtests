function [Wc1,Wc2, Wd, bc1,bc2, bd] = cnnParamsToStack(theta,imageDim,filterDim1,numFilters1,poolDim1,filterDim2,depth2,numFilters2,poolDim2,numClasses)
...
%% Reshape theta
indS = 1;
indE = filterDim1^2*numFilters1;
Wc1 = reshape(theta(indS:indE),filterDim1,filterDim1,numFilters1);
indS = indE+1;
