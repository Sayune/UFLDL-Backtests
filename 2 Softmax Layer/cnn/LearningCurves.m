...
theta = cnnInitParams(numClasses,hiddenLayer,imageDim);
...
for e = 1:epochs
    ...
    for s=1:minibatch:(m-minibatch+1)
        ...
        pred=false;
        [cost grad] = cnnCost(theta,mb_data,mb_labels,numClasses,hiddenLayer,pred);
...
%         fprintf('      Accuracy is %f\n',trainAcc);
        ...
        [~,~,testPreds]=cnnCost(theta,batchTest,batchTestLabels,numClasses,hiddenLayer,true);
